...
Проект включает веб-интерфейс для бота, доступный через GitHub Pages по адресу:
https://<your-username>.github.io/habr-rss-bot

Веб-интерфейс включает:

- Интерактивный чат с симуляцией работы бота
